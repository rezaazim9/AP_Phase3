...
public enum UIMessageConstants {
    ...
    TUTORIAL_MESSAGE, DISCONNECTED_MESSAGE,DISCONNECTED_TITLE,CONNECTED_MESSAGE,CONNECTED_TITLE,TUTORIAL_TITLE, EXIT_GAME_MESSAGE,OFFLINE_MESSAGE, EXIT_GAME_TITLE,CONNECTION_ERROR_TITLE,CONNECTION_ERROR_MESSAGE ,INVALID_PROFILE_ID_MESSAGE, SAVE_FILE_EXTENSION,
    PROFILE_ID_REGEX, SIGNIN_SUCCESSFUL_MESSAGE, SIGNUP_SUCCESSFUL_MESSAGE,OFFLINE_TITLE,INVALID_PROFILE_ID_TITLE, SIGNIN_SUCCESSFUL_TITLE, SIGNUP_SUCCESSFUL_TITLE,
    SIGNIN_INSTRUCTIONS;

    public String getValue() {
        return switch (this) {
            case PORTAL_TITLE -> "Save or Continue";
            case CONNECTED_MESSAGE -> "You have connected to the server";
            case CONNECTED_TITLE -> "Connected";
            case DISCONNECTED_MESSAGE -> "You have been disconnected from the server. You can continue playing offline";
            case DISCONNECTED_TITLE -> "Disconnected";
            case OFFLINE_TITLE -> "Offline Mode";
            case OFFLINE_MESSAGE -> "You are playing offline. You can't save your progress";
            case CONNECTION_ERROR_TITLE -> "Connection Error";
            case CONNECTION_ERROR_MESSAGE -> "Failed to connect to the server. Try again or play offline";
