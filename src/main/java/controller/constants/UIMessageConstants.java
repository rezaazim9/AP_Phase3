...
public enum UIMessageConstants {
    ...
    TUTORIAL_MESSAGE, TUTORIAL_TITLE, EXIT_GAME_MESSAGE, EXIT_GAME_TITLE,CONNECTION_ERROR_TITLE,CONNECTION_ERROR_MESSAGE ,INVALID_PROFILE_ID_MESSAGE, SAVE_FILE_EXTENSION,
