...
public enum UIConstants {
    ...
    MENU_BUTTON_WIDTH,LEADERBOARD_BUTTON_WIDTH,TEXT_SCALE, SLIDER_PRECISION_SCALE, MESSAGE_FADE_INTERVAL, MESSAGE_HEIGHT, MESSAGE_FONT_SIZE, DEFAULT_FONT_SIZE,
    ...
    public float getValue() {
        return switch (this) {
            ...
            case LEADERBOARD_BUTTON_WIDTH -> 350;
